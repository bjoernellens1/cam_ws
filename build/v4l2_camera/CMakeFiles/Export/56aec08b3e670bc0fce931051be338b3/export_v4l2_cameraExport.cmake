...
foreach(_cmake_expected_target IN ITEMS v4l2_camera::v4l2_camera v4l2_camera::v4l2_camera_node v4l2_camera::v4l2_camera_compose_test)
...
set_target_properties(v4l2_camera::v4l2_camera PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "rclcpp::rclcpp;rclcpp_components::component;rclcpp_components::component_manager;camera_info_manager::camera_info_manager;cv_bridge::cv_bridge;image_transport::image_transport"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_v4l2_cameraExport-*.cmake")
